...
import FAQDrawer from "./_components/faq-drawer";
...
const Page = async () => {
	...
	return (
		<div className="h-full flex flex-col px-4">
			<div
				className={cn(
					"fixed lg:container top-0 left-0 right-0 h-14 py-2 flex items-center bg-transparent backdrop-blur-sm px-4 justify-between opacity-95 z-20"
				)}
			>
				<Logo />
